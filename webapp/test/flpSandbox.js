		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#buscadorimagens-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"buscadorimagens-display": {
								"semanticObject": "buscadorimagens",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=buscadorimagens",
									"url": sap.ui.require.toUrl("buscadorimagens")
								}
							}
						}
					}
